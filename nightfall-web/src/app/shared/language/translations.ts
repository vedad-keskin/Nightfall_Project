...
export const BS: Record<TranslationKey, string> = {
    ...
    dire_wolf_desc: 'Zastrašujući alfa predator. Lovi sa čoporom, a zatim se budi sam svake druge noći da ušutka jednog igrača, sprečavajući ga da koristi svoju sposobnost sljedeće noći.',
    ...
    rule_ab_dire_wolf: 'STRAHOVUK: Zastrašujući alfa predator na strani Vukova. Budi se sa čoporom i učestvuje u ubijanju. Nakon što vukovi zaspu, Strahovuk se budi sam svake druge noći (1., 3., 5...) da ušutka jednog igrača. Ušutkani igrač ne može koristiti svoju aktivnu sposobnost sljedeće noći. Ušutkivanje djeluje samo na uloge koje se bude noću: Doktor, Stražar, Vrač i Šaman. Pasivne sposobnosti (oklop Viteza, besmrtnost Utvare, Luda, Dželat) nisu pogođene. Ne može ušutkati vukove, sebe, niti istog igrača kao prošli put. Stražaru izgleda kao Vukodlak.',
